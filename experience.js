const content_experience = {
    ru: {
        experience: {
            title: "Опыт работы",
            items: [
                "Технический менеджер проекта, Яндекс.Облако (8/2022 - по настоящее время)",
    ...
    en: {
        experience: {
            title: "Professional Experience",
                items: [
                "Technical Project Manager, Yandex Cloud (8/2022 - Present)",
    ...
    rs: {
        experience: {
            title: "Професионално искуство",
                items: [
                "Технички Менаџер пројекта, Yandex Облак (8/2022 - сада)",
