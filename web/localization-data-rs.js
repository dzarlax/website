const serbianTranslations = {
        ...
        intro: {
            ...
            description: '<strong>AI-Native извршни директор производа</strong> — 15 година на споју производа и инжењеринга. Тренутно водим <strong>Insight</strong> у Constructor-у — аналитика за то како engineering тимови заиста раде (и где AI adoption помаже или одмаже).<br><br>' +
                'Искуство кроз продуктовне домене: дата-платформе (<strong>DataLens у Yandex Cloud-у</strong>), B2C маркетплејсе (<strong>Yandex.Market</strong> — укључујући 7 дана рада као курир) и високо-волуменску валидацију (<strong>Руска пошта</strong>, 2M+ адреса дневно). Јаке ставове о томе када користити генеричке LLM-ове, а када fine-tуновати мале моделе за бизнис-критичне задатке.<br><br>' +
                'У личном стеку: <strong>Personal Memory</strong> (Go MCP сервер који комбинује семантичку меморију, document RAG и Todoist у једну tool површину за све моје агенте — Qdrant + локални embedding-и), <strong>Health Dashboard</strong> (мулти-тенантни сервер за Apple Health са сопственим SwiftUI iOS клијентом, AI брифинзима преко Gemini и <em>Energy Bank</em>-ом — непрекидни battery модел који интегрише физиолошки стрес и опоравак кроз дане), и <strong>Evening News</strong> (вести пајплајн са изворима из RSS / Telegram / web, summarization и категоризација преко Gemini са online учењем из корекција, дневни дајџести у Telegram + Telegraph) — све у продукцији.<br><br>' +
            ...
            items: [
                {
                    ...
                    location: 'Београд',
                    period: '10/2024 - сада',
                    description: "<strong>Insight (тренутни фокус):</strong> Мулти-тенантна аналитичка платформа за engineering организације. Прикупља податке из целог enterprise стека — dev алати (GitHub/Bitbucket/GitLab, Jira/YouTrack, Allure), AI алати (Cursor, Claude Code, GitHub Copilot, Claude Enterprise/Team/API, ChatGPT Team), sales/CRM (HubSpot, Salesforce), колаборација (Slack, M365, Zulip) и HR/org системи (BambooHR, Workday, LDAP) — и приказује adoption, usage, cost и productivity метрике по тимовима и особама. Medallion архитектура (Bronze/Silver/Gold) са унифицираним схемама преко хетерогених извора, tenant-aware на foundation нивоу, scorecards са Focus Modes и конфигурабилни dashboards.<br><br><strong>Ранији Constructor портфолио (2024–2025):</strong> Оркестрирао сам стратегију за Research (рачунска платформа на бази VS Code са Kubernetes хостингом), Model Engine (корпоративни AI слој) и University Chatbots.<br><br><strong>AI Advocacy:</strong> Интерни AI Advocate, обучавам product менаџере развоју AI агената, испоручујем AI агенте за специјализоване бизнис задатке."
                },
                {
                    ...
                    description: "<strong>DataLens (Yandex Cloud BI платформа):</strong> Технички PM за главни аналитички производ Yandex-а — open-source BI са дубоком ClickHouse интеграцијом, embedded dashboards-има, public API-јем и моделом permission/sharing за велике мулти-тимске инсталације. Скалирано до 20,000+ корисника у највећој инсталацији.<br><br><strong>Скоп:</strong> Водио open-source release и on-prem дистрибуцију, обликовао API површину производа за екстерне интеграторе, радио са инжењерингом на data modeling-у, оптимизацији упита и tenant изолацији. Customer research, телеметрија и roadmap definition."
                },
                {
                    ...
                    description: "<strong>Стратегија:</strong> Водио roadmap за брзо-растућу курирску платформу. Учествовао у развоју система аутоматског додељивања курира са алгоритамском маршрутизацијом.<br><br><strong>Теренско истраживање:</strong> Радио 7 дана као курир на платформи — ground-truth о стварном workflow возача, тачкама трења у апликацији и edge-случајевима диспечеризације које из канцеларије не видиш.<br><br><strong>Аналитика:</strong> Изградио свеобухватну аналитику за data-driven оперативне одлуке.<br><br><strong>Лидерство:</strong> Водио тим од 10 особа који је испоручивао клијентске функције и оперативна побољшања кроз hyper-growth."
                },
                {
                    title: 'Product Owner',
                    company: 'Руска пошта',
                ...
                },
                {
                    ...
                    description: "<strong>Производ:</strong> Parallels Access — remote-desktop апликација за iOS и Android (Parallels је купио Corel).<br><br><strong>Кариерни раст:</strong> Унапређен са QA Engineer-а на Program Manager-а 2014. — активно сам излазио из оквира QA у продуктовни рад, предлагао фичере и обликовао издања, док улога није достигла стварну одговорност.<br><br><strong>Продукт менаџмент:</strong> Водио издања ажурирања производа, надгледао документацију функција и укључивао резултате аналитике и повратних информација корисника у roadmap."
                }
            ]
        },
        education: {
