...
const englishTranslations = {
        ...
        items: [
            {
                ...
                description: "<strong>Insight (current focus):</strong> Multi-tenant analytics platform for engineering organizations. Ingests data across the full enterprise stack — dev tools (GitHub/Bitbucket/GitLab, Jira/YouTrack, Allure), AI tooling (Cursor, Claude Code, GitHub Copilot, Claude Enterprise/Team/API, ChatGPT Team), sales/CRM (HubSpot, Salesforce), collaboration (Slack, M365, Zulip), and HR/org systems (BambooHR, Workday, LDAP) — and surfaces it as adoption, usage, cost, and productivity metrics per team and person. Medallion architecture (Bronze/Silver/Gold) with unified schemas across heterogeneous sources, tenant-aware on the foundation level, scorecards with Focus Modes and configurable dashboards on top.<br><br><strong>Earlier Constructor portfolio (2024–2025):</strong> Orchestrated strategy across Research (VS Code-based computational platform with Kubernetes hosting), Model Engine (corporate AI layer), and University Chatbots.<br><br><strong>AI Advocacy:</strong> Internal AI Advocate, training product managers on AI agent development and shipping production AI agents for specialized business tasks."
            },
            {
    ...
    education: {
        ...
        items: [
            ...
            {
                degree: 'SaaS Metrics Fundamentals for Managers, Founders & Investors',
                institution: 'Udemy',
                type: 'course',
