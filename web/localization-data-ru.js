const russianTranslations = {
        ...
        footer_text: `© ${new Date().getFullYear()} Алексей Панфилов. Создано с AI-augmented разработкой.`,
        intro: {
            title: 'Head of Product',
            description: '<strong>AI-Native продуктовый лидер</strong> — 15 лет на стыке продукта и инженерии. Сейчас веду <strong>Insight</strong> в Constructor — аналитика для того, как engineering-команды реально работают (и где AI adoption помогает или мешает).<br><br>' +
                'Опыт по продуктовым доменам: дата-платформы (<strong>DataLens в Yandex Cloud</strong>), B2C-маркетплейсы (<strong>Яндекс.Маркет</strong> — включая 7 дней работы курьером), высоконагруженная валидация (<strong>Почта России</strong>, 2M+ адресов в день). Сильное мнение о том, когда использовать универсальные LLM, а когда дообучать небольшие модели для бизнес-критичных задач.<br><br>' +
                'В личном стеке: <strong>Personal Memory</strong> (Go MCP-сервер, объединяющий семантическую память, document RAG и Todoist в одну tool-поверхность для всех моих агентов — Qdrant + локальные эмбеддинги), <strong>Health Dashboard</strong> (multi-tenant сервер для Apple Health с собственным SwiftUI iOS-клиентом, AI-брифингами через Gemini и <em>Energy Bank</em> — непрерывной battery-моделью, интегрирующей физиологическую нагрузку и восстановление между днями), и <strong>Evening News</strong> (новостной пайплайн с источниками из RSS / Telegram / web, summarization и категоризацией через Gemini с online-обучением на корректировках, ежедневные дайджесты в Telegram + Telegraph) — всё в проде.<br><br>' +
                '<strong>Языки:</strong> Русский родной, английский свободно, сербский — базовый разговорный.'
        },
        skills: {
            ...
            items: [
                {
                    ...
                    description: "<strong>Insight (текущий фокус):</strong> Мульти-тенантная аналитическая платформа для engineering-команд. Собирает данные со всего корпоративного стека — dev-инструменты (GitHub/Bitbucket/GitLab, Jira/YouTrack, Allure), AI-инструменты (Cursor, Claude Code, GitHub Copilot, Claude Enterprise/Team/API, ChatGPT Team), sales/CRM (HubSpot, Salesforce), коллаборация (Slack, M365, Zulip) и HR/org (BambooHR, Workday, LDAP) — и считает adoption, usage, cost и productivity-метрики по командам и людям. Medallion-архитектура (Bronze/Silver/Gold) с унифицированными схемами поверх разнородных источников, tenant-aware на foundation-уровне, scorecards с Focus Modes и настраиваемые dashboards.<br><br><strong>Ранний портфель Constructor (2024–2025):</strong> Управлял стратегией Research (вычислительная платформа на базе VS Code с Kubernetes-хостингом), Model Engine (корпоративный AI-слой) и University Chatbots.<br><br><strong>AI Advocacy:</strong> Внутренний AI Advocate, обучаю PM-ов разработке AI-агентов, доставляю AI-агентов для специализированных бизнес-задач."
                },
                {
                    ...
                    description: "<strong>DataLens (BI-платформа Yandex Cloud):</strong> Технический PM флагманского аналитического продукта Яндекса — open-source BI с глубокой ClickHouse-интеграцией, embedded dashboards, public API и моделью permission/sharing для крупных мульти-командных инсталляций. Масштабировано до 20,000+ пользователей в крупнейшей установке.<br><br><strong>Scope:</strong> Драйвил open-source релиз и on-prem дистрибуцию, формировал API-поверхность продукта для внешних интеграторов, работал с инженерами над data modeling, оптимизацией запросов и tenant isolation. Customer research, телеметрия, roadmap definition."
                },
                {
                    ...
                    description: "<strong>Стратегия:</strong> Управлял roadmap для быстрорастущей курьерской платформы. Участвовал в развитии системы автоматического назначения курьеров с алгоритмической маршрутизацией.<br><br><strong>Полевое исследование:</strong> Отработал 7 дней курьером на платформе — ground-truth о реальном workflow водителя, точках трения в приложении и edge-кейсах диспетчеризации, которые из-за стола не увидишь.<br><br><strong>Аналитика:</strong> Построил комплексную аналитику для data-driven операционных решений.<br><br><strong>Лидерство:</strong> Руководил командой из 10 человек, выпускавшей клиентские фичи и операционные улучшения в период гиперроста."
                },
                {
                    title: 'Product Owner',
                ...
                },
                {
                    ...
                    description: "<strong>Редизайн мобильного:</strong> Возглавил редизайн мобильного приложения, давший +3 п.п. к конверсии.<br><br><strong>Оптимизация:</strong> Улучшил управление мобильной разработкой, выбор подрядчиков и процессы UI/UX прототипирования.<br><br><strong>Аналитика:</strong> Создал систему аналитики для организации и действий на основе исследований аудитории и конкурентного анализа.<br><br><strong>Технологии:</strong> Перевёл мобильное приложение на Swift и последний Android framework."
                },
                {
                ...
                },
                {
                    ...
                    description: "<strong>Продукт:</strong> Parallels Access — remote-desktop приложение для iOS и Android (Parallels приобретена Corel).<br><br><strong>Карьерный рост:</strong> Повышен с QA Engineer до Program Manager в 2014 — активно выходил за рамки QA в продуктовую работу, предлагал фичи и формировал релизы, пока роль не догнала реальную ответственность.<br><br><strong>Продукт-менеджмент:</strong> Руководил релизами обновлений, вел документацию функций и внедрял выводы аналитики, отзывов пользователей и бизнес-метрик в roadmap."
                }
            ]
        },
        education: {
        ...
        education_view_certificate: 'Смотреть сертификат',
        contacts: {
            contact: 'Контакты',
            email: 'Напишите мне',
        ...
        footer: {
            copyright: `© ${new Date().getFullYear()} Алексей Панфилов`,
